...
<head>
    ...
    <link href='http://fonts.googleapis.com/css?family=Ubuntu:300,400,500,700,300italic,400italic,500italic,700italic&amp;subset=latin,cyrillic-ext,greek-ext,greek,latin-ext' rel='stylesheet' type='text/css'>
...
<body>
	...
	<div class="header-container">
        ...
        <div class="row">
            ...
            <a href="https://www.facebook.com/AvaPremiumThemes" class="facebook-header" target="_blank"></a>
    ...
    <div class="homepage-text">
    	...
    	<div class="bottom-icon">
        	<a href="#parallax-one"><img src="images/homepage-text-bottom-icon.png" alt="Homepage Bottom Icon"></a>
        </div>
    </div>
    ...
    <div class="content-container">
        ...
        <div class="parallax-one">
        	...
        	<div class="row">
                	...
                	<div class="parallax-divider">
                  		<img src="images/icons/60px/white/appbar.people.multiple.png" alt="Read More About Us">
                    </div>
        ...
        <div class="page-container pattern-2" id="our-team">
        	...
        	<div class="row">
            	...
            	<div class="three columns padding-four-columns team-member mobile-two">
                	<img src="images/team/team-1.png" alt="Our Team">
            	...
            	<div class="three columns padding-four-columns team-member mobile-two">
                	<img src="images/team/team-2.png" alt="Our Team">
                    <h3 class="our-team-title">John Malkovich</h3>
                    <h3 class="our-team-subtitle">CEO & Founder</h3>
                    <div class="our-team-divider"></div>
                    <p class="our-team-text">Habitasse pulvinar elit tristique eleum auctor placerat sit ut acu uctor. Porttitor eetas sceleque, non. Ac egestas mauris!</p>
            	...
            	<div class="three columns padding-four-columns team-member mobile-two">
                	<img src="images/team/team-3.png" alt="Our Team">
                    <h3 class="our-team-title">John Malkovich</h3>
                    <h3 class="our-team-subtitle">CEO & Founder</h3>
                    <div class="our-team-divider"></div>
                    <p class="our-team-text">Habitasse pulvinar elit tristique eleum auctor placerat sit ut acu uctor. Porttitor eetas sceleque, non. Ac egestas mauris!</p>
            	...
            	<div class="three columns padding-four-columns team-member mobile-two">
                	<img src="images/team/team-4.png" alt="Our Team">
                    <h3 class="our-team-title">John Malkovich</h3>
                    <h3 class="our-team-subtitle">CEO & Founder</h3>
                    <div class="our-team-divider"></div>
                    <p class="our-team-text">Habitasse pulvinar elit tristique eleum auctor placerat sit ut acu uctor. Porttitor eetas sceleque, non. Ac egestas mauris!</p>
            	...
            	<div class="twelve columns page-section">
                	...
                	<h2 class="page-subtitle">We’re fortunate to work with <span>fantastic clients</span><br>from across the globe in over <span>11 countries</span> on design, branding, and <span>development projects.</span></h2>
                </div>
                
            	<div class="twelve columns">
                  <div class="section-divider testimonial-margin">
                        <img src="images/crown.png" alt="Read More About Us">
                    </div>
                </div>
       	  	  ...
       	  	  <div class="twelve columns testimonial">
                    ...
                    <div class="six columns testimonial-content mobile-four">
                        <div class="testimonial-content-inner">
                            ...
                            <p class="testimonial-content mobile-four">Habitasse pulvinar elit magnis tritue elementum auctor placerat sit ut cu auctor. Ac egestas mauris proin! Elementum auctor placerat sit. Habitasse pulvinar elit magnis tritue elementum.</p>
        ...
        </div><!-- Parallax Two - Content -->
        <div class="parallax-two">
            <div class="quote2-pattern"><div class="quote2-shape"></div></div>
        	<div class="row">
           	  	<div class="twelve columns parallax-container">
                	<h1 class="parallax-title">READ MORE ABOUT US</h1>
                	<div class="parallax-divider">
                  		<img src="images/icons/60px/white/appbar.book.open.writing.png" alt="Read More About Us">
                    </div>
                	<h2 class="parallax-subtitle">We love building and rebuilding brands.<br>Using colour, fonts and illustration, we brand companies in a way you’ll never forget.</h2>
                </div>
            </div>
        	...
        	<div class="row">
            	...
            	<div class="twelve columns hide-for-760">
                    <div class="section-divider">
                        <img src="images/crown.png" alt="Our Skills">
                    </div>
                </div>
        ...
        <div class="parallax-three">
            <div class="quote3-pattern"><div class="quote3-shape"></div></div>
        	<div class="row">
           	  	<div class="twelve columns parallax-container">
                	<h1 class="parallax-title">CHECK OUT OUR Portfolio</h1>
                	<div class="parallax-divider">
                  		<img src="images/icons/60px/white/appbar.camera.png" alt="Read More About Us">
                    </div>
                	<h2 class="parallax-subtitle">We love building and rebuilding brands.<br>Using colour, fonts and illustration, we brand companies in a way you’ll never forget.</h2>
                </div>
            </div>
        	...
        	<div class="row">
            	...
            	<div class="twelve columns portfolio-filter hide-for-760">
                    <ul class="filterOptions">
                        <li class="active"><a href="#" class="all"><img src="images/icons/40px/123.png" alt="All Projects" ><span>All Projects</span></a></li>
                        <li><a href="#" class="photography"><img src="images/icons/40px/96.png" alt="Photography"><span>Photography</span></a></li>
                        <li><a href="#" class="website-design"><img src="images/icons/40px/121.png" alt="Website Design"><span>Website Design</span></a></li>
                        <li><a href="#" class="branding"><img src="images/icons/40px/155.png" alt="Branding"><span>Branding</span></a></li>
                        <li><a href="#" class="logo-design"><img src="images/icons/40px/88.png" alt="Logo Design"><span>Logo Design</span></a></li>
                    </ul>
                </div>
                    ...
                    <ul class="ourHolder">
                        <li class="four columns item mobile-two" data-id="id-1" data-type="photography">
                            <div class="portfolio-item">
                            	<div class="portfolio-cat-image">
                           	    	<img src="images/icons/40px/white/96.png" alt="Portfolio Category Image">
                                </div>
                            	<div class="portfolio-hover-details hide-for-small">
                                	<div class="open-portfolio">
                                    	<a href="images/portfolio/1.png" class="open-portfolio-large" rel="prettyPhoto"></a>
                                    	<a href="#" data-reveal-id="single-project-photo" class="open-portfolio-link"></a>
                                    </div>
                                </div>
                            	<a href="images/portfolio/1.jpg" class="photo-link" rel="prettyPhoto"><img src="images/portfolio/1.jpg" alt="Portfolio Item" class="wide-image"></a>
                        ...
                        <li class="four columns item mobile-two" data-id="id-1" data-type="website-design">
                            <div class="portfolio-item">
                            	...
                            	<a href="images/portfolio/large/2.jpg" class="photo-link" rel="prettyPhoto"><img src="images/portfolio/2.jpg" alt="Portfolio Item" class="wide-image"></a>
                                <div class="portfolio-details">
                        ...
                        <li class="four columns item mobile-two" data-id="id-1" data-type="website-design">
                            <div class="portfolio-item">
                            	...
                            	<a href="images/portfolio/large/3.jpg" class="photo-link" rel="prettyPhoto"><img src="images/portfolio/3.jpg" alt="Portfolio Item" class="wide-image"></a>
                                <div class="portfolio-details">
                        ...
                        <li class="four columns item mobile-two" data-id="id-1" data-type="branding">
                            <div class="portfolio-item">
                            	...
                            	<a href="images/portfolio/large/4.jpg" class="photo-link" rel="prettyPhoto"><img src="images/portfolio/4.jpg" alt="Portfolio Item" class="wide-image"></a>
                                <div class="portfolio-details">
                        ...
                        <li class="four columns item mobile-two" data-id="id-1" data-type="logo-design">
                            <div class="portfolio-item">
                            	...
                            	<a href="images/portfolio/large/5.jpg" class="photo-link" rel="prettyPhoto"><img src="images/portfolio/5.jpg" alt="Portfolio Item" class="wide-image"></a>
                                <div class="portfolio-details">
                        ...
                        <li class="four columns item mobile-two" data-id="id-1" data-type="photography">
                            <div class="portfolio-item">
                            	...
                            	<a href="images/portfolio/large/6.jpg" class="photo-link" rel="prettyPhoto"><img src="images/portfolio/6.jpg" alt="Portfolio Item" class="wide-image"></a>
                                <div class="portfolio-details">
                                	<h4 class="portfolio-title"><a href="#" data-reveal-id="single-project-video">Photo by Sean McCabe!</a></h4>
                                	<div class="portfolio-divider"></div>
                                    <p class="portfolio-categories">Photography, Website Design</p>
        ...
        <div class="parallax-four">
            <div class="quote4-pattern"><div class="quote4-shape"></div></div>
        	<div class="row">
           	  	<div class="twelve columns parallax-container">
                	<h1 class="parallax-title">CHECK OUT OUR SERVICES</h1>
                	<div class="parallax-divider">
                  		<img src="images/icons/60px/white/appbar.cogs.png" alt="Read More About Us">
                    </div>
                	<h2 class="parallax-subtitle">We love building and rebuilding brands.<br>Using colour, fonts and illustration, we brand companies in a way you’ll never forget.</h2>
                </div>
            </div>
        ...
        <div class="page-container pattern-1" id="services">
        	...
        	<div class="row services-wide-banner">
                <div class="twelve columns"><img src="images/services-banner.png" alt="Our Services"></div>
          	</div>
            	...
            	<div class="twelve columns services-top">
                    <div class="four columns services first-column mobile-two">
                        ...
                        <div class="services-image">
                            ...
                            <img src="images/services/1.png" alt="Our Strategy">
                    ...
                    <div class="four columns services middle-column mobile-two">
                        ...
                        <div class="services-image">
                            <div class="services-divider-top"></div>
                            <img src="images/services/2.png" alt="Our Strategy">
                            <div class="services-divider-bottom"></div>
                        </div>
                        <p class="services-text">Habitasse pulvinar elit  tristique elm auctor placerat sit ut acu uctor. Ptor eetas scelerisque, non. Ac egestas mauris proin, pulviar tuis!</p>
                    </div>
                    <div class="four columns services last-column mobile-two">
                        ...
                        <div class="services-image">
                            <div class="services-divider-top"></div>
                            <img src="images/services/3.png" alt="Our Strategy">
                            <div class="services-divider-bottom"></div>
                        </div>
                        <p class="services-text">Habitasse pulvinar elit  tristique elm auctor placerat sit ut acu uctor. Ptor eetas scelerisque, non. Ac egestas mauris proin, pulviar tuis!</p>
                    </div>
                    <div class="four columns services first-column mobile-two">
                        ...
                        <div class="services-image">
                            <div class="services-divider-top"></div>
                            <img src="images/services/4.png" alt="Our Strategy">
                            <div class="services-divider-bottom"></div>
                        </div>
                        <p class="services-text">Habitasse pulvinar elit  tristique elm auctor placerat sit ut acu uctor. Ptor eetas scelerisque, non. Ac egestas mauris proin, pulviar tuis!</p>
                    </div>
                    <div class="four columns services middle-column mobile-two">
                        ...
                        <div class="services-image">
                            <div class="services-divider-top"></div>
                            <img src="images/services/5.png" alt="Our Strategy">
                            <div class="services-divider-bottom"></div>
                        </div>
                        <p class="services-text">Habitasse pulvinar elit  tristique elm auctor placerat sit ut acu uctor. Ptor eetas scelerisque, non. Ac egestas mauris proin, pulviar tuis!</p>
                    </div>
                    <div class="four columns services last-column mobile-two">
                        ...
                        <div class="services-image">
                            <div class="services-divider-top"></div>
                            <img src="images/services/6.png" alt="Our Strategy">
                            <div class="services-divider-bottom"></div>
                        </div>
                        <p class="services-text">Habitasse pulvinar elit  tristique elm auctor placerat sit ut acu uctor. Ptor eetas scelerisque, non. Ac egestas mauris proin, pulviar tuis!</p>
                    </div>
        ...
        <div class="parallax-five">
            <div class="quote5-pattern"><div class="quote5-shape"></div></div>
        	<div class="row">
           	  	<div class="twelve columns parallax-container">
                	<h1 class="parallax-title">LATEST NEWS</h1>
                	<div class="parallax-divider">
                  		<img src="images/icons/60px/white/appbar.globe.png" alt="Read More About Us">
                    </div>
                	<h2 class="parallax-subtitle">We love building and rebuilding brands.<br>Using colour, fonts and illustration, we brand companies in a way you’ll never forget.</h2>
                </div>
            </div>
                        ...
                        <div class="news-section" data-thumb="images/our-news.png">
                            ...
                            <div class="four columns news-item mobile-two">
                                <section class="news-cat-image">
                                    <img src="images/icons/40px/white/124.png" alt="News Image">
                                </section>
                                <span class="news-date">Published on January 18, 2013</span>
                                <a href="#" class="photo-link" data-reveal-id="single-news"><img src="images/news/1.jpg" alt="News Image" class="wide-image"></a>
                            ...
                            <div class="four columns news-item mobile-two">
                                ...
                                <span class="news-date">Published on January 18, 2013</span>
                                <a href="#" class="photo-link" data-reveal-id="single-news"><img src="images/news/2.jpg" alt="News Image" class="wide-image"></a>
                                <section class="news-details">
                                	<h3 class="news-title"><a href="#" data-reveal-id="single-news">Et elementum odio amet consectue single elementum etcon!</a></h3>
                                	<div class="news-title-divider"></div>
                                	<p class="news-content">Habitasse pulvinar elit  tristique elmauctr placerat sit ut acu uctor. Ptor eetas sceris que, non. Ac egesta, pulviar tuis!</p>
                            ...
                            <div class="four columns news-item mobile-two">
                                ...
                                <span class="news-date">Published on January 18, 2013</span>
                                <a href="#" class="photo-link" data-reveal-id="single-news"><img src="images/news/3.jpg" alt="News Image" class="wide-image"></a>
                                <section class="news-details">
                                	<h3 class="news-title"><a href="#" data-reveal-id="single-news">Et elementum odio amet consectue single elementum etcon!</a></h3>
                                	<div class="news-title-divider"></div>
                                	<p class="news-content">Habitasse pulvinar elit  tristique elmauctr placerat sit ut acu uctor. Ptor eetas sceris que, non. Ac egesta, pulviar tuis!</p>
                            ...
                            <div class="four columns news-item mobile-two">
                                ...
                                <span class="news-date">Published on January 18, 2013</span>
                                <a href="#" class="photo-link" data-reveal-id="single-news"><img src="images/news/4.jpg" alt="News Image" class="wide-image"></a>
                                <section class="news-details">
                                	<h3 class="news-title"><a href="#" data-reveal-id="single-news">Et elementum odio amet consectue single elementum etcon!</a></h3>
                                	<div class="news-title-divider"></div>
                                	<p class="news-content">Habitasse pulvinar elit  tristique elmauctr placerat sit ut acu uctor. Ptor eetas sceris que, non. Ac egesta, pulviar tuis!</p>
                            ...
                            <div class="four columns news-item mobile-two">
                                ...
                                <span class="news-date">Published on January 18, 2013</span>
                                <a href="#" class="photo-link" data-reveal-id="single-news"><img src="images/news/5.jpg" alt="News Image" class="wide-image"></a>
                                <section class="news-details">
                                	<h3 class="news-title"><a href="#" data-reveal-id="single-news">Et elementum odio amet consectue single elementum etcon!</a></h3>
                                	<div class="news-title-divider"></div>
                                	<p class="news-content">Habitasse pulvinar elit  tristique elmauctr placerat sit ut acu uctor. Ptor eetas sceris que, non. Ac egesta, pulviar tuis!</p>
                            ...
                            <div class="four columns news-item mobile-two">
                                ...
                                <span class="news-date">Published on January 18, 2013</span>
                                <a href="#" class="photo-link" data-reveal-id="single-news"><img src="images/news/6.jpg" alt="News Image" class="wide-image"></a>
                                <section class="news-details">
                                	<h3 class="news-title"><a href="#" data-reveal-id="single-news">Et elementum odio amet consectue single elementum etcon!</a></h3>
                                	<div class="news-title-divider"></div>
                                	<p class="news-content">Habitasse pulvinar elit  tristique elmauctr placerat sit ut acu uctor. Ptor eetas sceris que, non. Ac egesta, pulviar tuis!</p>
        ...
        <div class="parallax-six">
            <div class="quote6-pattern"><div class="quote6-shape"></div></div>
        	<div class="row">
           	  	<div class="twelve columns parallax-container">
                	<h1 class="parallax-title">CONTACT US TODAY</h1>
                	<div class="parallax-divider">
                  		<img src="images/icons/60px/white/appbar.email.png" alt="Read More About Us">
                    </div>
                	<h2 class="parallax-subtitle">We love building and rebuilding brands.<br>Using colour, fonts and illustration, we brand companies in a way you’ll never forget.</h2>
                </div>
            </div>
        ...
        <div class="page-container pattern-1" id="contact">
        	...
        	<div class="row">
                    ...
                    <div id="contact-slider">
                        ...
                        <div class="contact-details" data-thumb="images/contact-details.png">
                            <div class="four columns first-column mobile-three-one contact-margin">
                                ...
                                <p class="contact-text">One Auctor Stockton Street<br>London, UK 94108</p><p class="contact-text"><span>EMAIL:</span> info@dreamer.com</p><p class="contact-text"><span>PHONE:</span> 415.415.4155</p>
                            </div>
                            ...
                            <div class="four columns last-column mobile-three-one contact-margin">
                                ...
                                <div class="contact-image hide-for-760">
                                    <div class="contact-divider-top"></div>
                                    <img src="images/new-york.jpg" alt="London">
                                    <div class="contact-divider-bottom"></div>
                                </div>
                                <p class="contact-text">One Auctor Stockton Street<br>New York, NY 94108</p><p class="contact-text"><span>EMAIL:</span> info@dreamer.com</p><p class="contact-text"><span>PHONE:</span> 415.415.4155</p>
                            </div>
                        </div>
                                ...
                                <div class="twelve columns contact-form-div">
                                    <div class="eight columns mobile-four-760">
                                        <div class="six columns first-column mobile-two-670">
                                            <div class="row collapse">
                                                <div class="two mobile-one columns">
                                                    <span class="prefix"><img src="images/icons/40px/1.png" alt="Contact Name"></span>
                                                </div>
                                        ...
                                        <div class="six columns middle-column mobile-two-670">
                                            <div class="row collapse">
                                                <div class="two mobile-one columns">
                                                    <span class="prefix"><img src="images/icons/40px/2.png" alt="Contact Email"></span>
                                                </div>
                                                <div class="ten mobile-three columns">
                                        ...
                                        <div class="six columns first-column mobile-two-670">
                                            <div class="row collapse">
                                                <div class="two mobile-one columns">
                                                    <span class="prefix"><img src="images/icons/40px/3.png" alt="Phone Number"></span>
                                                </div>
                                                <div class="ten mobile-three columns">
                                        ...
                                        <div class="six columns middle-column mobile-two-670">
                                            <div class="row collapse">
                                                <div class="two mobile-one columns">
                                                    <span class="prefix"><img src="images/icons/40px/4.png" alt="Website"></span>
                                                </div>
                                                <div class="ten mobile-three columns">
                                        ...
                                        <div class="six columns first-column mobile-two-670">
                                            <div class="row collapse">
                                                <div class="two mobile-one columns">
                                                    <span class="prefix"><img src="images/icons/40px/5.png" alt="Project Budget"></span>
                                                </div>
                                                <div class="ten mobile-three columns">
                                        ...
                                        <div class="six columns middle-column mobile-two-670">
                                            <div class="row collapse">
                                                <div class="two mobile-one columns">
                                                    <span class="prefix"><img src="images/icons/40px/6.png" alt="Timeframe"></span>
                                                </div>
                                                <div class="ten mobile-three columns">
                                        ...
                                        <div class="six columns first-column mobile-two-670">
                                            <div class="row collapse">
                                                <div class="two mobile-one columns">
                                                    <span class="prefix"><img src="images/icons/40px/7.png" alt="You're interested in?"></span>
                                                </div>
                                                <div class="ten mobile-three columns">
                                        ...
                                        <div class="six columns middle-column mobile-two-670">
                                            <div class="row collapse">
                                                <div class="two mobile-one columns">
                                                    <span class="prefix"><img src="images/icons/40px/8.png" alt="How did you hear about us?"></span>
                                                </div>
                                                <div class="ten mobile-three columns">
            	...
            	<div class="twelve columns">
                    <div class="section-divider">
                        <img src="images/social-media.png" alt="Read More About Us">
                    </div>
                </div>
            	<div class="twelve columns">
                ...
                <div class="twelve columns sharing-icons">
                    <div class="facebook-share-button">
                        ...
                        <div class="facebook-share-button-inner">
                            <iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fthemeforest.net%2Fuser%2FAVAThemes%2Fportfolio&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;action=like&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px;" allowTransparency="true"></iframe>
                        </div>
                    </div>
                    <div class="twitter-tweet-button">
                        <div class="twitter-tweet-button-over">Tweet It</div>
                        <div class="twitter-tweet-button-inner">
                        <a href="https://twitter.com/share" class="twitter-share-button" data-via="AvaThemes" data-related="AvaThemes">Tweet</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="../../../platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
                        </div>
                    </div>
                    <div class="linkedin-share-button">
                        <div class="linkedin-share-button-over">Share It</div>
                        <div class="linkedin-share-button-inner">
                            <script src="../../../platform.linkedin.com/in.js" type="text/javascript"></script><script type="IN/Share" data-url="http://themeforest.net/user/AVAThemes/portfolio" data-counter="right"></script>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-container">
        	<div class="row">
            	<div class="four columns first-column hide-for-small">
                	<p class="footer-left">ALL RIGHTS RESERVED 2013</p>
                </div>
            	<div class="four columns middle-column back-to-top hide-for-small">
           	    	<a href="#homepage"><img src="images/back-to-top.png" alt="Go Back To Top"></a>
                </div>
            	<div class="four columns last-column mobile-four">
                	<p class="footer-right"><a href="http://themeforest.net/user/AVAThemes/portfolio" target="_blank">CREATED BY AVATHEMES</a></p>
                </div>
            </div>
        </div>
    </div>
	...
	<div id="single-project-video" class="reveal-modal large">
    	...
    	<div class="single-project-image-video">
        	<iframe src="http://player.vimeo.com/video/48511895" width="500" height="281" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
        </div>
        ...
        <div class="four columns first-column">
    		<p class="single-project-content"><span class="dropcap-1">S</span>it sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Placerat sit? In pulvinar a in a, et, proin?</p>
        </div>
        <div class="four columns middle-column">
    		<p class="single-project-content"><span class="dropcap-2">S</span>it sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Nunc odio ac! Dapibus et. Nec!</p>
        </div>
        <div class="four columns last-column">
    		<p class="single-project-content"><span class="dropcap-3">S</span>it sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Dapibus et. Nec! Aliquam hac, porttitor? Hac dis!</p>
        </div>
        ...
        <div class="single-project-tab-details">
            ...
            <ul class="tabs-content contained">
                <li class="active" id="simpleContained1Tab">Photos in Portfolio and News are property of <a href="http://seanwes.com/">Sean McCabe</a> and <a href="http://pixelpixelpixel.com/">pixelpixelpixel.com</a></li>
                <li id="simpleContained2Tab">Sit sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Placerat sit? In pulvinar a in a, et, proin?</li>
                <li id="simpleContained3Tab">Sit sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Placerat sit? In pulvinar a in a, et, proin?</li>
            </ul>
        </div>
        
        <div class="eight columns first-column">
    		<p class="single-project-content">Sit sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Placerat sit? In pulvinar a in a, et, proin? Sit sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Nunc odio ac! Dapibus et. Nec! Aliquam hac, porttitor?</p>
        </div>
        <div class="four columns middle-column">
    		<p class="single-project-content">Sit sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Nunc odio ac! Dapibus et. Nec!</p>
        </div>
	...
	<div id="single-project-photo" class="reveal-modal large">
    	...
    	<div class="single-project-image-video">
   	    	<img src="images/portfolio/single-project/1.jpg" alt="Project Image">
        </div>
        ...
        <div class="single-project-tab-details">
            ...
            <ul class="tabs-content contained">
                <li class="active" id="simpleContained4Tab">Photos in Portfolio and News are property of <a href="http://seanwes.com/">Sean McCabe</a> and <a href="http://pixelpixelpixel.com/">pixelpixelpixel.com</a></li>
                <li id="simpleContained5Tab">Sit sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Placerat sit? In pulvinar a in a, et, proin?</li>
                <li id="simpleContained6Tab">Sit sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Placerat sit? In pulvinar a in a, et, proin?</li>
            </ul>
        </div>
	...
	<div id="single-news" class="reveal-modal single-news medium">
    	...
    	<div class="single-news-image-video">
   	    	<img src="images/news/single/1.jpg" alt="Project Image">
        </div>
        ...
        <div class="twelve columns first-column">
    		<p class="single-news-content"><span class="dropcap-1">P</span>hotos in Portfolio and News are property of <a href="http://seanwes.com/">Sean McCabe</a> and <a href="http://pixelpixelpixel.com/">pixelpixelpixel.com</a> Placerat sit? In pulvinar a in a, et, proin? Sit sagittis aliquet cras, rhoncus cras arcu odio risus a, auctor urna. Mus magna pulvinar, velit turpis parturient! Proin et. Enim mid proin mid eu augue odio elementum? Nunc odio ac! Dapibus et. Nec! Aliquam hac, porttitor?</p>
    		...
    		<p class="single-news-content">Velit integer elit lacus ut enim nascetur augue proin magnis, turpis mus phasellus, placerat cursus scelerisque augue scelerisque, habitasse, et lectus? Porta natoque lacus urna cum, dictumst a risus facilisis, lundium, mid nisi lundium amet vel sit cursus proin in!</p>
            
    		<p class="single-news-content">Lorem pulvinar penatibus in tortor porta purus auctor nisi lectus nascetur, porta? Turpis turpis? Lundium placerat ac eu adipiscing porttitor, et diam vut et! Cum augue! Massa arcu scelerisque pulvinar? Proin dictumst. Porttitor tincidunt egestas!</p>
        </div>
    ...
    <!-- Parallax JS File -->
    <script src="javascripts/jquery.parallax-1.1.3.js" type="text/javascript" ></script>
